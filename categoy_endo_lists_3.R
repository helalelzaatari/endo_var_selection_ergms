...
load("//nas//longleaf//home//helal//final_endo_lists.RData")
...
#relative_1  <- replicate(n=100, relative_aic(network_1, all_endo_list_1), simplify="TRUE")


## relative AIC change matrix for network 2 ##
#relative_2  <- replicate(n=100, relative_aic(network_2, all_endo_list_2), simplify="TRUE")



## relative AIC change matrix for network 3 ##
#relative_3 <- replicate(n=100, relative_aic(network_3, all_endo_list_3), simplify="TRUE")


## relative AIC change matrix for network 4 ##
#relative_4  <- replicate(n=100, relative_aic(network_4, all_endo_list_4), simplify="TRUE")


## relative AIC change matrix for network 5 ##
#relative_5  <- replicate(n=100, relative_aic(network_5, all_endo_list_5), simplify="TRUE")



## relative AIC change matrix for network 6 ##
#relative_6 <- replicate(n=100, relative_aic(network_6, all_endo_list_6), simplify="TRUE")



## relative AIC change matrix for network 7 ##
#relative_7  <- replicate(n=100, relative_aic(network_7, all_endo_list_7), simplify="TRUE")


## relative AIC change matrix for network 8 ##
#relative_8  <- replicate(n=100, relative_aic(network_8, all_endo_list_8), simplify="TRUE")



## relative AIC change matrix for network 9 ##
relative_9 <- replicate(n=100, relative_aic(network_9, all_endo_list_9), simplify="TRUE")


## relative AIC change matrix for network 10 ##
relative_10  <- replicate(n=100, relative_aic(network_10, all_endo_list_10), simplify="TRUE")


## relative AIC change matrix for network 11 ##
relative_11  <- replicate(n=100, relative_aic(network_11, all_endo_list_11), simplify="TRUE")
...
save.image("endo_categories_3.RData")
